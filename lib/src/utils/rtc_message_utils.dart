...
class RtcDeviceTestUtils {
  ...
  static Future<void> startAudioPlaybackDeviceTest(
      dynamic rtcEngine, String filePath, int indicationInterval) async {
    try {
      if (rtcEngine == null) {
      ...
      // 调用SDK方法
      final result = js_util.callMethod(rtcEngine,
  ...
  static Future<void> startAudioDeviceRecordTest(
      dynamic rtcEngine, int indicationInterval,
    ...
    try {
      ...
      final result =
          js_util.callMethod(rtcEngine, 'startAudioDeviceRecordTest', args);
